							...
							<thead>
								<tr>
									<th data="true" class="footable-first-column"
										>Tên đề tài</th>
									<th data="true" style="width: 200px !important;">Số lượng giảng viên</th>
									<th data="true" style="width: 180px !important;">GVHD</th>
									<th data="true" style="width: 140px !important;">Ngày phản biện</th>
									<th data-hide="phone" class="footable-last-column"
										style="width: 100px !important;">Chi tiết</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${list}" var="o">			
										<tr class="">
											<td class="footable-first-column"><span
												class="footable-toggle"></span><span class="text-info">${o.getDT(o.detai).tenDT}</span></td>
											<td>${o.soLuong}</td>
											<td>${o.getDT(o.detai).GVHD}</td>
											<td>${o.ngayPB}</td>
											<td class="footable-last-column"><a
												href="detailPB?id=${o.id}" class="btn btn-success btn-xs">Xem</a>
											</td>
