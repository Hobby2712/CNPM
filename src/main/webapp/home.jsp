...
<body>
    <div id="menu">
        <li class="list-group-item"
            ...
            DANH MỤC</li>
        <a href="home" class="list-group-item">Trang Chủ</a>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel panel-default">
                            <div style="color: rgb(39, 86, 156);" class="panel-heading">
                                <h4 style="text-align:center;font-family: verdana;color:rgb(87,87,87);">THÔNG BÁO
                                </h4>
                            </div>
                                    ...
                                    <a href="#">
                                        <li class="list-group-item active">
                                            <p>
                                                ...
                                                Thông báo khóa k2020 nộp bằng tốt nghiệp trước
                                                ngày 21-12-2022
                                    ...
                                    <a href="#">
                                        <li class="list-group-item active">
                                            <p>
                                                ...
                                                Sinh viên nghỉ tết dương lịch 2023 2 ngày 01-01-2022 và 02-01-2022
