...
<body>
	<div id="menu">
		<li class="list-group-item"
			...
			href="listduyetDT" class="list-group-item  "> Duyệt đề tài</a>
		<hr />
	</div>
						...
						<div class="col-md-3">
							...
							<div id="desktop-menu">
								<div class="panel panel-default">
									...
									<a href="dkdt" class="list-group-item active">Đăng kí đề tài</a><a
										...
										<div class="content">
											<form action="dangki" method="post">
												...
												<div class="user-details">
													...
													<div class="input-box">
														<span class="details">Chuyên ngành</span> <select
															name="chuyenNganh">
