...
<body>
    <div id="menu">
        ...
        <a href="list_sinh_vien.html" class="list-group-item ">Thông tin
            sinh viên</a>
        <a href="quanLiNhom(TN).html" class="list-group-item active "> Quản lý nhóm
        </a>
        <a href="nopbaocao.html" class="list-group-item  "> Nộp báo cáo
        </a>
        <hr />
    </div>
...
<div style="color: rgb(39, 86, 156);" class="panel-heading">
                                <h4 style="text-align:center;font-family: verdana;color:rgb(87,87,87);"> Nộp báo cáo
                                </h4>
                            </div>
                                        ...
                                        <table width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>${chude }</td>
                                                    <td>${noidung }</td>
                                                    <td><a href="uploads/${document }">${document }</a></td>
