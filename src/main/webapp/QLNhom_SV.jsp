						...
						<table class="table footable-loaded footable tablet breakpoint"
							...
							<thead>
								<tr>
									...
									<th data="true">Tên thành viên nhóm</th>
									<th data="true" style="width: 140px !important;">Chức vụ</th>
							...
							<tbody>
								...
								<tr class="">
									<td class="footable-first-column"><span
										class="footable-toggle"></span><span class="text-info">${info.uId}</span></td>
									<td><span class="name"></span>${info.fullName}</td>
									<td>Trưởng nhóm</td>
									<td></td>
								</tr>
								<c:forEach items="${list}" var="o">
									<tr class="">
										...
										<td class="footable-last-column"><a
											href="deleteTV?uid=${o.uId}" class="btn btn-danger btn-xs">Xóa
												khỏi nhóm</a></td>
									</tr>
								</c:forEach>
								...
								<tr>
									<td colspan="6">
										<div class="pagination-container">
											<ul class="pagination">
												<a href="themTV"><button id="back" type="button"
														class="btn btn-success">Thêm thành viên</button></a>
