									...
									<table class="table table-hover footable-loaded footable">
										<tbody>
											...
											<tr>
												...
												<c:if test="${detail.trangThai == 2}">
													<td>Đã được duyệt</td>
												</c:if>
												<c:if test="${detail.trangThai == 3}">
											...
											<tr>
												...
												<td colspan="2" style="text-align: center;">
													...
													<button id="dangky" type="button"
														onclick="location.href='huyDT?dt=${detail.id}';"
														class="btn btn-info" style="text-align: right !important;">Huỷ</button>
