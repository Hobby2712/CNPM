				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<table class="table footable-loaded footable tablet breakpoint"
							...
							<thead>
								<tr>
									<th class="footable-first-column">MSSV</th>
									<th>Tên sinh viên</th>
									<th style="width: 170px !important;">Chuyên
										ngành</th>
									<th class="footable-last-column">Hành
										động</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${list}" var="o">
									<tr class="">
										<td class="footable-first-column"><span class="text-info">${o.uId}</span></td>
										...
										<td><a
											href="addNT?id=${id}&&uid=${o.uId}" class="btn btn-success btn-xs">Thêm
												nhóm trưởng</a></td>
									</tr>
								</c:forEach>
								...
								<tr>
									<td colspan="6">
										...
										<div class="pagination-container">
											<ul class="pagination">
												<ul class="pagination">
													<a href="listDTHD"><button type="button"
